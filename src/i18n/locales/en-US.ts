export default {
  ...
  cashflow: {
    ...
    loading: 'Loading cashflow picks...',
    empty: 'No cashflow picks yet. The list refreshes weekly — check back soon.',
    error: 'Failed to load cashflow picks.',
